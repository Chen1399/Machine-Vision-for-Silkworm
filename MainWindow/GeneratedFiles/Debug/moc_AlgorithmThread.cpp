...
#include "../../../AlgorithmThread/AlgorithmThread.h"
...
QT_MOC_LITERAL(1, 16, 23), // "AlgorithmThreadFinished"
QT_MOC_LITERAL(2, 40, 0), // ""
QT_MOC_LITERAL(3, 41, 3), // "Mat"
QT_MOC_LITERAL(4, 45, 5), // "Image"
QT_MOC_LITERAL(5, 51, 8) // "al_index"

    },
    "AlgorithmThread\0AlgorithmThreadFinished\0"
    "\0Mat\0Image\0al_index"
};
...
void AlgorithmThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->AlgorithmThreadFinished((*reinterpret_cast< Mat(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (AlgorithmThread::*_t)(Mat , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AlgorithmThread::AlgorithmThreadFinished)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject AlgorithmThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_AlgorithmThread.data,
      qt_meta_data_AlgorithmThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void AlgorithmThread::AlgorithmThreadFinished(Mat _t1, int _t2)
{
